...
actionToIdxDict = {'023': [0], '007': [1], '094': [1], '012': [2], '050': [3], '010': [4]}
...
f = open('outputLog_' + testSubject + '_withBal_trans_onlyFeat.txt', "a")

# f.write('Action list: {}\n'.format(actionLists[3]))
# f.write('Old indexes: {}'.format(oldActIdxs[0]))

fileName = 's4-10_' + testSubject + '_v5_bal_trans_onlyFeat_2.h5'
...
for line in dataLines:
    ...
    if testSubject in line:
        ...
        typeStr = 'Validated with ' + str(allSeq) + ' samples...'
        print(typeStr, end="\r")
